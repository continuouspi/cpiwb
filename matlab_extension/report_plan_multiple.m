...
save_name= '';
saving_path='';
report_content = struct('Code',1,'Plot',1);
model_names = {};
% Odes={}; 
% Ode_num={}; 
% Init_tokens={};
...
%                 Init_tokens{end+1}=init_tokens;
    ...
    function generate_report_Callback(source,eventdata) 
       ...
       report_generate_multiple(model_names,definations, save_name, saving_path,start_time, end_time, report_content)
