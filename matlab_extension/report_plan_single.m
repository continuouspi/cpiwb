...
report_content = struct('Code',1,'ODEs',0,'Plot',0,'Num',0);
chosen_solvers = {};
...
f.Visible = 'on';
   ...
   function generate_report_Callback(source,eventdata) 
      ...
      if report_content.Code==1 && report_content.ODEs==0 && report_content.Plot==0 && report_content.Num==0
         report_generate_single(cpi_defs,save_name,saving_path,report_content); 
...
%          
         ...
         fprintf('Done.');
         report_generate_single(cpi_defs,save_name,saving_path,report_content,odes); 
...
%          process_def = data2.proc_def; 
        ...
        create_process_simulation(t, Y, start_time, file_name, ...
         ...
         report_generate_single(cpi_defs,save_name,saving_path,report_content,odes,start_time,end_time,chosen_solvers,legend_strings,t,Y); 
